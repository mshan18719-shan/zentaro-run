...
export function createMap() {
    ...
    for (let x = 1; x <= 17; x++) map[6][x] = 15; // spike ceiling underneath

    // Crystal + rock decoration
    map[12][10] = 9;   // rock (non-solid, visual only)
    map[12][16] = 13;  // crystal (non-solid, visual only)
    ...
    // Floor A — row 4, gap at col 37 (right side)
    ...
    for (let x = 119; x <= 122; x++) map[3][x] = 1;
    ...
    for (let x = 123; x <= 127; x++) map[3][x] = 1;
    ...
    map[8][133] = 1;
    map[9][133] = 15; // spike under toehold
    ...
    map[4][144] = 15; map[4][149] = 15; // spike edges
...
export function createLevelEntities(map, TILE, player) {
    ...
    // * ── Stars ─────────────────────────────────────────────────
    const stars = [
        new Star(58 * TILE - 25, 2 * TILE - 64),    // Zone 3 — high reward platform
        new Star(84 * TILE + 16, 0 * TILE - 32),    // Zone 4 — highest void platform
        new Star(147 * TILE, 1 * TILE - 64),   // Zone 7 — door summit
    ];
